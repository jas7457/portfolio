...
export default function Portfolio() {
	return (
		<>
			<section className="h-screen flex items-center justify-center text-center text-5xl bg-dark dark:bg-white text-white dark:text-text border-b-4 border-primary">
				<div>
					<div>
			...
			<ol className="space-y-2">
				{showcaseList.map(({ tech, percent }) => (
					<li key={tech.name} className="flex relative">
						...
						></div>
						<div className="relative bg-primary-dark text-white w-32 text-center py-1 px-2">
							<div
								className={clsx(
						...
						<div className="flex-grow bg-gray-300 flex justify-end items-center pr-2">{percent}%</div>
					</li>
				))}
			</ol>
		</AnimateOnScreen>
